...
> 收纳旧板块中无法明确归属到单一公司的手撕算法题、笔试题型和通用代码模板。
...
- [1. 大模型算法岗实习面经 攒人品](#batch2-p1)
  - [1. multi-head attention](#batch2-p1-q1)
  - [2. 1D RoPE](#batch2-p1-q2)
  - [3. 前向传播反向传播numpy推导实现](#batch2-p1-q3)
  - [4. KL_divergence手撕](#batch2-p1-q4)
  - [5. 损失函数手撕](#batch2-p1-q5)
  - [6. 梯度下降法求解某个给定函数的极值点](#batch2-p1-q6)
  - [7. Causal Conv（在VideoVAE中最主流的技术，包括3DConv和2+1D Conv）](#batch2-p1-q7)
  - [8. 手撕Diffusion](#batch2-p1-q8)
